...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-body">
        <iframe id="preview" src="<?php echo base_url(); ?>Reportsales/retur_sales_pdf" width="100%" height="1000px"></iframe>
      </div>
    </div>
...
<script type="text/javascript">
  ...
  $('#btnsearch').click(function(e) {
    ...
    let url = '<?php echo base_url(); ?>Reportsales/retur_sales_pdf?';
  ...
  $('#btndownloadexcell').click(function(e) {
    ...
    let url = '<?php echo base_url(); ?>Reportsales/retur_sales_excell?';
    url += '&start_date=' + start_date;
    url += '&end_date=' + end_date;
    url += '&customer_id=' + customer_id;
