...
<div class="content-wrapper">
  ...
  <section class="content">
          ...
          <div class="row">
            <div class="col-sm-3">
              ...
              <div class="form-group">
                ...
                <input id="start_date" name="start_date" type="date" class="form-control" value="<?php echo date('Y-m-d'); ?>">
              </div>
            </div>
            <div class="col-sm-3">
              <!-- text input -->
              <div class="form-group">
                ...
                <input id="end_date" name="end_date" type="date" class="form-control" value="<?php echo date('Y-m-31'); ?>">
              </div>
            </div>
    ...
    <div class="card">
      <div class="card-body">
        <iframe id="preview" src="<?php echo base_url(); ?>Reportsales/sales_due_pdf" width="100%" height="1000px"></iframe>
      </div>
    </div>
...
<script type="text/javascript">
  ...
  $('#btnsearch').click(function(e) {
    ...
    let url = '<?php echo base_url(); ?>Reportsales/sales_due_pdf?';
  ...
  $('#btndownloadexcell').click(function(e) {
    ...
    let url = '<?php echo base_url(); ?>Reportsales/sales_due_excell?';
    url += '&start_date=' + start_date;
    url += '&end_date=' + end_date;
    url += '&customer_id=' + customer_id;
    url += '&sales_id=' + sales_id;
