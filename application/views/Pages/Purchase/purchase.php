    ...
    <div class="card">
      ...
      <div class="card-body">
        <table id="examplepurchase" class="table table-bordered" style="width:100%">
          ...
          <tbody>
            <?php foreach($data['purchase_list'] as $row){ ?>
              <tr>
            ...
            <td>
              ...
              <?php }else{ ?>
                <button class="btn btn-sm btn-primary" onclick="detail('<?php echo $row->hd_purchase_id; ?>')" disabled><i class="fas fa-eye"></i></button>
              <?php } ?>
              ...
              <?php }else{ ?>
                <button class="btn btn-sm btn-danger" onclick="deletes('<?php echo $row->hd_purchase_id; ?>', '<?php echo $row->hd_purchase_invoice; ?>')" disabled><i class="fas fa-trash"></i></button>
              <?php } ?>
            </td>
          </tr>
        <?php } ?>
