                    ...
                    <div class="row">
                        <div class="col-md-6" style="width: 10%;">
                            <div class="header-title" style="text-align: left;">
                                <img src="<?php echo base_url(); ?>dist/img/logo.jpeg" width="100%" style="margin-top: 30px;">
                            </div>
                        </div>
                        <div class="col-md-6" style="width: 70%;">
                            <div class="header-title" style="text-align: center; ">
                                <h2 style="text-decoration: underline;">Nota Penjualan</h2>
                                <p>NEO Furniture & Electronics <br />
                                Jl. Desa Kapur, Ruko Bhayangkara Asri 2, no. 2-3 <br />
                                0812-508-6166 / IG: Neofurniture</p>
                            </div>
                        </div>
                    </div>
