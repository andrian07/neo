      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Detail Retur Pembelian</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="invoice p-3 mb-3">
            ...
            <!-- info row -->
            <?php foreach($data['get_detail_retur_purchase_header'] as $row){ ?>
            <div class="row invoice-info">
              ...
              <!-- /.col -->
              <div class="col-sm-4 invoice-col">
                <b>Invoice <?php echo $row->hd_retur_purchase_invoice; ?></b><br>
                <br>
                <b>Tanngal Pembelian:</b> <?php $date = date_create($row->hd_retur_date); echo date_format($date,"d-M-Y"); ?><br>
            ...
            <div class="row" style="margin-top: 20px;">
              <div class="col-12 table-respurchasensive">
                <table class="table table-striped">
                  ...
                  <tbody>
                    <?php foreach($data['get_detail_retur_purchase_detail'] as $row){ ?>
                    <tr>
