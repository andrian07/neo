              ...
              <tr>
                ...
                <td>
                 <?php if($row->user_id != 1){ ?>
                  ...
                  <button data-id="<?php echo $row->user_id; ?>" data-name="<?php echo $row->user_name; ?>" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#exampleModaledit"><i class="fas fa-edit"></i></button>
                  ...
                  <button data-id="<?php echo $row->user_id; ?>" data-name="<?php echo $row->user_name; ?>" class="btn btn-sm btn-info"><i class="fas fa-key"></i></button>
                <?php } ?>
              </td>
            </tr>
          <?php } ?>
...
<script type="text/javascript">
  ...
  $('#edit').click(function(e){
    ...
    $.ajax({
      ...
      dataType: "json",
      data: {id:id, user_name_edit:user_name_edit},
      success : function(data){
        if (data.code == "200"){
          location.reload();
          Swal.fire('Saved!', '', 'success'); 
